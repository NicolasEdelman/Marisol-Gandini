        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimateOnScroll className="order-1 lg:order-2 delay-100">
            <div className="h-full flex flex-col justify-between">
              ...
              <Button
                className="bg-primary hover:bg-primary-hover text-white text-lg py-6 px-8 self-start mt-auto"
                onClick={() => {
          ...
          <AnimateOnScroll className="order-2 lg:order-1">
            <div className="relative h-[650px] rounded-lg overflow-hidden shadow-xl">
              <Image
